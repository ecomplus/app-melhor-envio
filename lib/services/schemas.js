...
module.exports = {
  calculateRequest: (payload, app) => {
    ...
    try {
      let calculateObj = {}
      calculateObj.from = {}
      if (payload.application.hasOwnProperty('hidden_data') && payload.application.hidden_data.hasOwnProperty('from')) {
        ...
        calculateObj.from = JSON.parse(app.me_default_set)
      }

      if (payload.params.to.hasOwnProperty('zip') && payload.params.to.zip == '') {
        return false
      }
      calculateObj.to = {}
      ...
      return {
        ...
        shipping_line: {
          ...
          custom_fields: [
            ...
            {
              field: 'jadlog_agency',
              value: String(packageRequest.application.data.jadlog_agency)
            }
          ]
        }
      }
