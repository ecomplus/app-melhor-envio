...
module.exports = {
  calculateRequest: (payload) => {
    ...
    try {
      ...
      logger.log('Erro ao realizar parse do schema.')
      return false
    }
  },
      ...
      return {
        ...
        shipping_line: {
          ...
          custom_fields: [
            ...
            {
              field: 'jadlog_agency',
              value: packageRequest.application.data.jadlog_agency
            }
          ]
        }
      }
  ...
  calculateDefault: (payload) => {
    if (typeof payload.application !== 'undefined') {
      if (typeof payload.application.hidden_data !== 'undefined' && typeof payload.application.hidden_data.minimum_subtotal !== 'undefined') {
        return { free_shipping_from_value: payload.application.hidden_data.minimum_subtotal }
      } else {
