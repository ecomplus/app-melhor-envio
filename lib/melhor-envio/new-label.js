  ...
  if (address) {
    if (typeof address === 'string') {
      ...
      ;[
        ...
        merchantData[field] = address[field] || ''
      })
      if (typeof address.city === 'object') {
        merchantData.city = address.city.city || ''
        if (address.city.state) {
          merchantData.state_abbr = address.city.state.state_abbr || ''
          merchantData.country_id = (address.city.state.country && address.city.state.country.id) || ''
        }
      }
    }
  }
